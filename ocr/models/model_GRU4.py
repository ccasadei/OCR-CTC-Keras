...
class Model_GRU4(Model_BASE):
    ...
    def get_model(self, training):
        ...
        m = DenseNet201(include_top=False, input_tensor=inputs, input_shape=input_shape)

        inner = m.output  # (None, 32,

        # passo da CNN a RNN
        inner = Reshape(target_shape=(32, 15360), name='reshape')(inner)  # (None, 32, 15360)
        ...
        inner = Dense(parameter.num_classes, kernel_initializer='he_normal', name='dense2')(gru2_merged)
